...
class ComponentUtils {
    companion object {
        ...
        const val COMPONENT_HASS_TURN_ON = "luly:LampenAnSchalten"
        const val COMPONENT_HASS_TURN_OFF = "luly:LampenAusSchalten"
        const val COMPONENT_HASS_LIGHT_SET = "luly:SzenenSchalten"
